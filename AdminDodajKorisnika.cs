...
namespace Diplomski
{
    public partial class formaAdminDodajKorisnika : Form
    {
        Serializer serializer;
        Stream fs;
        List<Korisnik> korisnici;
        string putanja = "korisnik.bin";
        public formaAdminDodajKorisnika()
        {
            InitializeComponent();
        ...
        string lozinka = "";
        private void formaAdminDodajKorisnika_FormClosed(object sender, FormClosedEventArgs e)
        {
